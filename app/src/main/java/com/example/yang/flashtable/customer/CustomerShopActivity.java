...
public class CustomerShopActivity extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    TextView tv_show_name, tv_show_consumption, tv_show_low, tv_show_offer, tv_show_location, tv_show_category;
    ...
    private void setDetail(){
        ...
        String low = info.low_consumption + getResources().getString(R.string.dollars);
