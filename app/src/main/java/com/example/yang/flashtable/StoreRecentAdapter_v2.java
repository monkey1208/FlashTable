...
public class StoreRecentAdapter_v2 extends ArrayAdapter<CustomerAppointInfo> {
    ...
    public StoreRecentAdapter_v2(Context context, List<CustomerAppointInfo> list){
